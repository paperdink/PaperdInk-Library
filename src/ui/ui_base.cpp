...
void PaperdinkUIClass::display_text(GxEPD2_GFX& display, int16_t x, int16_t y, const char *string, int16_t w, int16_t h, const GFXfont* font, uint8_t color, uint8_t size)
{
    int16_t xt, yt;
