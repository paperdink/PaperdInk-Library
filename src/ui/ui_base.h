...
class PaperdinkUIBaseClass
{
    public:
        ...
        void display_text(GxEPD2_GFX& display, int16_t x, int16_t y, const char* string, int16_t w = 0, int16_t h = 0, const GFXfont* font = &Code_New_Roman9pt7b, uint8_t color = GxEPD_BLACK);
